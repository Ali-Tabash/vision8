...
class site1controller extends Controller
{
    public function index()
    {
        ...
        $about_f =' Freelancer is a free bootstrap theme created by Start Bootstrap.
        ...
        $about_l ='You can create your own custom avatar for the masthead,
      ...
      return view('side1.index', compact('title','desc','about_f','about_l','file','portfolio','data'));
    }
}
